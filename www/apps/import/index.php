...
<div class="container">
	...
	<br/>
	<b>File Upload:</b><br/>
	<p>Upload files by dragging and dropping them in the "Import and Edit Data" window below.  <b>Note: Filenames that start with a "." cannot be uploaded.  Also, folder names cannot have a space</b>. SimTK will automatically expand files with the following suffixes: .zip, .tar.gz, .tar.</p>
